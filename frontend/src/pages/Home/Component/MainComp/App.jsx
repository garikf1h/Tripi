        ...
        <div class="row">
          <div className="home-section">
            <h1 id="description-paragraph">
              Tripi is your go-to tool in order to plan a perfect trip in the
              beautiful country of Israel!
              <br />
              choose an attraction that will let you explore the history and
              nature of israel
              <br />
              find a near by restaurant according to your preferences
              <br />
              & if you want to do an over-night trip, find a cool lodging place
              in the area.
              <br />
              and the best part?
            </h1>
